...
namespace cling {
  ...
  MetaSema::ActionResult MetaSema::actOnxCommand(llvm::StringRef file,
    ...
    const std::string tryCallThese[] = {
      ...
      //"__ROOT_main__",  //FIXME: maybe enable this?
    };
  ...
  void MetaSema::actOndebugCommand(llvm::Optional<int> mode) const {
    static constexpr clang::codegenoptions::DebugInfoKind DebugInfo[] = {
    ...
    static constexpr size_t N = std::extent<decltype(DebugInfo)>::value;
